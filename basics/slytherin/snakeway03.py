...
def to_the_right(is_start, is_end):
    output = ""
...
time_to_sleep = 0.5
counter = 0
user_end = int(input("How long does the snake has to go? "))

while keep_running:
    is_first_round = counter == 0
    is_last_round = counter == user_end
    to_the_right(is_first_round, is_last_round)
    ...
    keep_running = not is_last_round
